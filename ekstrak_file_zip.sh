...
if [[ "${#gagal[@]}" -ne 0 ]]; then
	if [[ "${#gagal[@]}" -eq 1 ]]; then
		echo "[-] Menu nomor 8 tidak bisa digunakan, karena ada alat yang belum diinstal."
		echo ""
		...
		echo "[-] Menu nomor 8 tidak bisa digunakan, karena ada alat-alat yang belum diinstal."
		echo ""
